...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var request, textToSpeechClient, buffer, outputFile_1, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                // Write the file
                fs_1.default.writeFile(outputFile_1, buffer, 'binary', function (err) {
                    if (err)
                        throw err;
                    console.log('Got audio!', outputFile_1);
                });
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
